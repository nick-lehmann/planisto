...
import { parseSemesterString, Semester } from '../Semester.entity'
...
class TUDresdenScraper {
    ...
    async go(): Promise<void> {
        const degreeOverviews = await this.modulesOfDegree("https://wwwdek.inf.tu-dresden.de/mole-web/catalogs/wise2021/modules/index/courses/de")
    ...
    async parseCatalog(): Promise<SemesterLink[]> {
        const response = await this.scraper.get('https://tu-dresden.de/ing/informatik/studium/lehre/lehrangebotskataloge')
